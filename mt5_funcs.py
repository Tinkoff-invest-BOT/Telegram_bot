...
INDICATORS = ['CLEAR', 'ALMA', 'APO', 'BIAS', 'CFO', 'CG', 'CMO', 'COPPOCK', 'CTI', 'DECAY', 'DECREASING', 'DEMA', 'DPO', 'EBSW', 'EMA', 'ENTROPY', 'ER', 'FWMA', 'HMA', 'HWMA', 'INCREASING', 'INERTIA', 'JMA', 'KAMA', 'KDJ', 'KURTOSIS', 'LINREG', 'LOG_RETURN', 'MAD', 'MEDIAN', 'MIDPOINT', 'MOM', 'PERCENT_RETURN', 'PSL', 'PWMA', 'QUANTILE', 'RMA', 'ROC', 'RSI', 'RSX', 'RVI', 'SINWMA', 'SKEW', 'SLOPE', 'SMA', 'SSF', 'STDEV', 'SWMA', 'T3', 'TEMA', 'TRIMA', 'UI', 'VARIANCE', 'VHF', 'VIDYA', 'WMA', 'ZLMA', 'ZSCORE']
